...
$(document).ready(function () {
  ...
  rangeSlider.noUiSlider.on("update", function (values, handle) {
    ...
    const leftValue1 = document.querySelector(".noUi-connect").style.left;
    const leftValue2 = $(".noUi-origin.noUi-background")[0].style.left;
    if (parseInt(leftValue1).toPrecision() !== 0) {
      document.getElementById("slider-range-value1").style.left = leftValue1;
      if (parseInt(leftValue1).toPrecision() > 10) {
        document.getElementById("slider-range-temp1").style.display = "block";
      } else {
        document.getElementById("slider-range-temp1").style.display = "none";
      }
    }
    if (parseInt(leftValue2).toPrecision() !== 0) {
      document.getElementById("slider-range-value2").style.left = leftValue2;
      if (parseInt(leftValue2).toPrecision() < 95) {
        document.getElementById("slider-range-temp2").style.display = "block";
      } else {
        document.getElementById("slider-range-temp2").style.display = "none";
      }
    }
